...
class VescUart
{
	...
	public:
       ...
       /** Variable to hold firmware version */
        ...
        //Specific Functions for Scubajet Pro Protable Series:

         /**
         * @brief      Turns on Scubajet Wireless Power for 2s
         *             Must be called in the fist 200ms after Power on
         */
        void setSCUBA_POWER_ON(void);
        

         /**
         * @brief      SSC Power Keep Alive 
         *             Activates SSC Powwer for 135sec 
         */
        void sendSCUBA_POWER_KEEPALIVE(void);

         /**
         * @brief      SSC Power Keep Alive 
         *             Activates LED Nose
         */
        void setSCUBA_LED_ON(void);

         /**
         * @brief      SSC Power Keep Alive 
         *             Deativates LED NOSE 
         */
        void setSCUBA_LED_OFF(void);
